...
月份效应（Month-of-the-Year Effect） 实证研究发现，在大多数的证券市场中存在某个
或某些特定月份的平均收益率年复一年显著地异于其他各月平均收益率的现象，这种市场异象被称作“月份效应”。  

在美国的股票市场表现为“1月效应”，即1月份的平均收益率显著高于其他月份的平均收益。
该现象最早由美国学者瓦切尔(Wachte1)于1942年发现，但直到1976年罗兹弗(Rozef)和金乃尔(Kinney)系统地
将这一异象揭示出来，“1月效应”才逐渐进入现代金融学者的视野，并逐渐形成一套科学严谨的“月份效应”研究体
系，包括“1月效应”主要体现在小规模公司的股票上，并相应地提出了“税减假说”等理论解释。  

张兵给出了基于资金面季节性流动规律的简要解释，总结起来有两方面：第一，资金面的季节变化，我国股市年末
往往面临着各种形式的资金抽回，而来年初这些资金又会回流，这一资金运动规律决定了股市的“春涨”、“冬藏”；
第二，重大利好政策往在2、3月份发布，从而引发“春涨”现象 。
...
'''
从1993年至2018年共26年，上证指数有13年是下跌的，另外13年是上涨的，很fair哦，看来上证指数是属天秤座的。
其中，跌幅最大的五年分别为：
2008年（-65.39%），1994年（-22.30%），2018年（-21.85%），2011年（-21.68%），2001年（-20.62%）；
涨幅最大的五年分别为：
2006年（130.43%），2007年（96.66%），2009年（79.98%），1996年（65.14%），2014（52.87%）。
平均收益率35.12%，标准差为135.24%，可见，尽管A股市场波动性非常大，特别是前十年，但是整体上来看，并没有大
家口中说的那么糟糕。但是为啥赚钱的永远是少数人呢？本质上是因为“知情者”总是是少数的，而财富遵循“幂律分布”（二八法则），
此处不详细展开。
 
### 月份效应检验
所谓“月份效应”，主要是指股票市场中存在某个或某些特定月份的平均收益率年复一年显著地异于其他各月平均收益率的现象。
有实证研究表明，美国股票市场表现为“1月效应”，即1月份的平均收益率为正，且显著高于其他月份的平均收益。该现象最早由
Wachte1（1942）发现，但直到1976年Rozef和Kinney系统地将这一异象揭示出来，“1月效应”才引起金融界的注意。美国等发达
国家对“月份效应”的讨论和研究已走向成熟，但是由于A股运行时间较短，并且由于文化差异（节假日安排）导致的交易时间不一致，
其“月份效应”特征可能异于我国，因此仍有必要进一步挖掘和探讨。
检验思路：
（1）将数据分成两组：m月份和其他月份；
（2）检验两组数据的平均值是否相等
'''
